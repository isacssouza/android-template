...
public class MovieFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeLayout = (SwipeRefreshLayout) inflater.inflate(com.isacssouza.template.R.layout.fragment_main, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView movieList = ButterKnife.findById(swipeLayout, com.isacssouza.template.R.id.movie_list);
        ...
        swipeLayout.setColorSchemeResources(com.isacssouza.template.R.color.main_color);
